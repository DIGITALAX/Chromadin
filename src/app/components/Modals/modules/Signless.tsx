...
const Signless: FunctionComponent<{ dict: any }> = ({ dict }): JSX.Element => {
  ...
  return (
    ...
    >
      <div
        className="relative w-[90vw] sm:w-[70vw] half:w-[60vw] min-w-fit md:w-[30vw] h-fit col-start-1 place-self-center bg-offBlack rounded-md font-dosis text-white"
        id="boxBg"
      ...
      >
        <div className="relative w-full h-fit flex items-center justify-center p-3 gap-3 flex-col cursor-default">
          ...
          <div className="relative w-fit h-fit flex">
            <div
              className={`relative px-3 py-1 flex text-center items-center justify-center rounded-md bg-black w-28 h-8 ${
