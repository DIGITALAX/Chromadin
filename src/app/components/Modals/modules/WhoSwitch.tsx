        ...
        >
          {reactors?.map((reactor: Account, index: number) => {
            return (
              <div
                key={index}
                className="relative w-full h-14 p-2 flex flex-row items-center justify-start font-conso bg-black text-white cursor-pointer border border-black"
                onClick={() => {
              ...
              >
                <div className="relative w-fit h-fit flex flex-row gap-3 items-center justify-center">
                  <div className="relative w-8 h-8 rounded-full border border-black items-center justify-center bg-black">
                    <Image
