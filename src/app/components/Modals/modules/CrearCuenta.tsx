...
const CrearCuenta: FunctionComponent<{ dict: any }> = ({
  ...
  return (
    ...
    >
      <div
        className="relative w-[90vw] sm:w-[70vw] half:w-[60vw] min-w-fit md:w-[40vw] lg:w-[40vw] h-fit col-start-1 place-self-center bg-offBlack font-dosis rounded-md text-white"
        id="boxBg"
        ...
        <div className="relative w-full h-fit flex flex-col gap-3 items-center justify-center p-3">
          ...
          <div className="relative w-full h-fit flex flex-col gap-3 items-center justify-center">
            <div className="relative items-center justify-center flex w-fit h-fit">
              <label
                className="relative bg-black w-20 rounded-full h-20 flex items-center justify-center cursor-pointer"
                onClick={(e) => {
                  e.stopPropagation();
                }}
              >
            ...
            <div className="relative w-full h-fit flex items-start justify-between flex-row gap-3">
              <div className="relative w-full h-fit flex flex-col gap-1.5 items-start justify-start">
                ...
                <input
                  ...
                  className="relative bg-black w-full h-8 focus:outline-none p-1"
              ...
              <div className="relative w-full h-fit flex flex-col gap-1.5 items-start justify-start">
                ...
                <input
                  ...
                  className="relative w-full bg-black h-8 focus:outline-none p-1"
            ...
            <div className="relative w-full h-fit flex flex-col gap-1.5 items-start justify-start">
              ...
              <textarea
                ...
                className="relative w-full h-14 overflow-y-scroll focus:outline-none p-1 bg-black"
                value={account?.bio}
                style={{
                  resize: "none",
                }}
          ...
          <div className="relative w-fit h-fit flex">
            <div
              className={`relative px-3 py-1 flex items-center justify-center rounded-md bg-black w-28 h-8 ${
                !accountLoading &&
