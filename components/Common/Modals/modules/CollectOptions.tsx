              ...
              return (
                ...
                (item.type === "drop" ? (
                  <div
                    ...
                    key={indexTwo}
                  >
                    <div className="relative w-full h-fit flex items-start justify-start font-arcade text-white text-sm">
                      {item?.title}
                    </div>
                    <div className="relative w-full h-12 p-px rounded-md flex flex-row items-center justify-center font-arcade text-azul text-center border border-azul">
                      <div className="relative bg-offBlack flex flex-row w-full h-full justify-start items-center rounded-md p-2 gap-2">
                        <div
                    ...
                    {item.dropOpen && (
                      <div className="absolute flex items-start justify-center w-full h-fit max-height-[7rem] overflow-y-scroll z-50 bg-offBlack top-20 p-px border border-azul rounded-md">
                          ...
                          {item.dropValues?.map(
                            (value: string, indexThree: number) => {
                              return (
                                <div
                                  key={indexThree}
                                  className="relative w-full h-8 py-px bg-offBlack items-center justify-center flex text-azul text-sm uppercase font-arcade hover:bg-skyBlue hover:text-white cursor-pointer"
                                  onClick={() => {
                                    item.setValue(
                                      indexTwo === 4
                  ...
                  <div className="relative flex items-center justify-center flex-col w-fit h-fit pb-1.5 gap-2">
                    <div className="relative w-fit h-fit row-start-1 font-arcade text-white text-sm whitespace-pre-wrap break-words sm:whitespace-nowrap justify-self-start self-center text-left">
                      {item?.title}
                    </div>
                    <input
                      type="number"
                      id={id}
                      className={`relative w-20 bg-offBlack text-azul h-12 row-start-2 rounded-md border border-azul p-1.5 font-arcade justify-self-start self-center caret-transparent`}
